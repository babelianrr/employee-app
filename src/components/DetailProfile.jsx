  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      Swal.fire({
        ...
        try {
          const response = await axios.put(API_URL + "admin/profile/" + values.id, values, configs)
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Detail Profil</h1>
              </div>
              {
                Profile ? (
                  <div className="row">
                    <div className="col">
                      <form onSubmit={formik.handleSubmit}>
                        <div className="row mb-4">
                          <div className="col-6">
                            <button className="btn btn-secondary" type="button" onClick={handleCancel}>Kembali</button>
                          </div>
                        </div>
                        <div className="row">
